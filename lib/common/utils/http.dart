...
import 'package:chat_friend/common/utils/utils.dart';
      ...
      case DioErrorType.response:
        {
          try {
            ...
            switch (errCode) {
              ...
              case 404:
                return ErrorEntity(
                    code: errCode, message: "Unable to connect to server");
              case 405:
                return ErrorEntity(
                    code: errCode, message: "The request method is forbidden");
              case 500:
                return ErrorEntity(
